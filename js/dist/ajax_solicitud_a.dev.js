...
console.log('solicitudA'); //FORMULARIOS DE ADMIN.PHP

var formCargarRegistroSolicitudA = document.getElementById("cargarRegistro-solicitud-a");
var formEliminarRegistroSolicitudA = document.getElementById("registrosEliminar-solicitud-a");
var formModificarRegistroSolicitudA = document.getElementById('modificar-registro-solicitud-a');
var formGenerarSolicitudA = document.getElementById('generar-solicitud-a'); //ACCIONDES DE CADA FORMALACION
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      if (response == -1) {
        ...
        $(msg).fadeOut(1000); //ID GENERADO REPETIDO INTENTE NUEVAMENTE
      }
      ...
      if (response == -8) {
        ...
        msg.innerHTML = "\n                    <div class=\"alert alert-info\" role=\"alert\">Solicitud A N\xB0- ".concat(response, "</div>");

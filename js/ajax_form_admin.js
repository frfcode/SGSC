const formCrearUsuario = document.getElementById('crearUsuario');
const formCrearGrupo = document.getElementById('agregarGrupo');
const formAsignarGrupoUsuario = document.getElementById('asignarGrupoUsuario');
const formEliminarUsuario = document.getElementById('eliminarUsuario');
const formEliminarAsignacion = document.getElementById('eliminarAsignacion');
const formEliminarGrupo = document.getElementById('eliminarGrupo');
const formAprobarSolicitud1 = document.getElementById('aprobarSolicitudPaso1');
const formAprobarSolicitud2 = document.getElementById('aprobarSolicitudPaso2');
const formAprobarSolicitud3 = document.getElementById('aprobarSolicitudPaso3');
const formAprobarSolicitud4 = document.getElementById('aprobarSolicitudPaso4');
const formAprobarSolicitud5 = document.getElementById('aprobarSolicitudPaso5');
const formTiempo = document.getElementById('tiempoform');
//const formVigencia = document.getElementById('vigenciaform');
const formDirigido = document.getElementById('dirigidoform');
const formEliminarTiempo = document.getElementById('tiempoEliminarForm');
const formEliminarVigencia = document.getElementById('vigenciaEliminarForm');
const formEliminarDirigido = document.getElementById('dirigidoEliminarForm');
...
const formAgregarPlantilla = document.getElementById('agregarPlantilla');
const formConfigurarPlantilla = document.getElementById('configurarPlantilla');
...
/****************************************************************/
    formCrearUsuario.addEventListener('submit',function(e){
        ...
        setTimeout(function(){
            formCrearUsuario.user.value = ''; formCrearUsuario.password.value = '';
...
let archivo = document.getElementById('archivoplantilla');
let contenido = document.getElementById('plantillaContenido');
archivo.addEventListener('change', function(){
    let imageExt = archivo.value.split('.');
...
formAgregarPlantilla.addEventListener('submit', function(e){
    e.preventDefault();
    //let archivoEnvio = formAgregarPlantilla.archivoplantilla.value.replace(/^.*[\\\/]/, '');
    let archivo = formAgregarPlantilla.archivoplantilla;
    var msg = document.getElementById('resultadoPlantilla');
    let contenido = document.getElementById('plantillaContenido');
    //console.log(archivoEnvio)
...
formConfigurarPlantilla.addEventListener('submit', function(e){
    e.preventDefault();
    let plantillaS1 = formConfigurarPlantilla.plantillaSolicitud1.value
    let plantillaS2 = formConfigurarPlantilla.plantillaSolicitud2.value
    let plantillaS3 = formConfigurarPlantilla.plantillaSolicitud3.value
    let plantillaS4 = formConfigurarPlantilla.plantillaSolicitud4.value
    let plantillaS5 = formConfigurarPlantilla.plantillaSolicitud5.value
...
function ajaxFormAprobacionS1SA(url, send, result) {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            var msg = document.getElementById(result);
            msg.innerHTML = `
                <div class="alert alert-info" role="alert">Codigo de Solicitud - ${response}</div>`
...
function ajaxFormAprobacionS3SA(url, send, result) {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            var msg = document.getElementById(result);
            msg.innerHTML = `
                <div class="alert alert-info" role="alert">Codigo de Aprobacion - ${response}</div>`
            $(msg).fadeOut(1000);

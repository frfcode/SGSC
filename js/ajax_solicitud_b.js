console.log('solicitud b')
//FORMULARIOS DE ADMIN.PHP
const formTelefonoSB = document.getElementById('telefonoSB');
const formNombreSB = document.getElementById('nombreSB');
const formPaisesSB = document.getElementById('paisesSB');
const formGenerarSolicitudBTelefonos = document.getElementById('solicitud_b_telefonos');
const formGenerarSolicitudBNombres = document.getElementById('solicitud_b_nombres');
const formGenerarSolicitudBPaises = document.getElementById('solicitud_b_paises');

...
$i = 1; $id = $_SESSION['id'];
if($QueryB = mysqli_query($link,"SELECT id_contador, meses, pais, empresa FROM registro WHERE id_usuario = '$id' AND estatus_generado = 'NO' AND tipo_solicitud = 'SB' AND empresa = 'CLARO' ")){

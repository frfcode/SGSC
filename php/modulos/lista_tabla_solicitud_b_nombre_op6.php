...
$i = 1; $id = $_SESSION['id'];
if($QueryB = mysqli_query($link,"SELECT id_contador, nombre FROM registro WHERE id_usuario = '$id' AND estatus_generado = 'NO' AND tipo_solicitud = 'SB' AND nombre != '' AND tipo_opcion = 6")){
